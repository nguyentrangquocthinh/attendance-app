...
public class MainActivity extends AppCompatActivity {
	...
	// lấy dữ liệu nhập vào và thêm vào arrayList
	...
	private void showUpdateDialog(int position) {
		...
		dialog.setListener((className, subjectName)->
				updateClass(className, subjectName, position));
	}

	// cap nhat lop
	private void updateClass(String className, String subjectName, int position) {
